// To parse this data:
//
//   import { Convert, BuscarGIFResponse } from "./file";
//
//   const buscarGIFResponse = Convert.toBuscarGIFResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BuscarGIFResponse {
    data:       Gif[];
...
export class Convert {
    public static toBuscarGIFResponse(json: string): BuscarGIFResponse {
        return cast(JSON.parse(json), r("BuscarGIFResponse"));
    }

    public static buscarGIFResponseToJson(value: BuscarGIFResponse): string {
        return JSON.stringify(uncast(value, r("BuscarGIFResponse")), null, 2);
    }
}
